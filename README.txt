...
We have met all problem set requirements. 

Provide some overview of the code design. Don't go into details; just give us the big picture.

We did the initial setup (created a purple cube), completed linFact and transFact, did view change, and completed the object manipulation in the motion function. We wrote a helper function doMtoOwrtA taking into account the auxiliary frame. 
...
Press ‘v’ key to change the view mode between The sky camera frame, The frame of cube 1, and The frame of cube 2. 
Press Left button of the mouse: moving the mouse right/left rotates around the y-direction.
Press Left button of the mouse: moving the mouse up/down rotates around the x-direction.
Press Right button: moving the mouse right/left translates in the x-direction.
Press Right button: moving the mouse up/down translates in the y-direction.
Press Middle button (or both left and right buttons down): moving the mouse up/down translates in the z-direction. For apple mouse, you need to press ”Option/Alt” (or space) key + left button.
